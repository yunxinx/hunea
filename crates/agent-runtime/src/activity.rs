use mo_ai_core::ToolCall as AiToolCall;
use mo_core::session::{
...
#[cfg(test)]
mod tests {
    use mo_ai_core::ToolCall;
    use mo_core::session::{RuntimeToolActivityContent, RuntimeToolActivityStatus};
    use mo_tools::{ToolDefinition, ToolKind, ToolRegistry, ToolResult};
