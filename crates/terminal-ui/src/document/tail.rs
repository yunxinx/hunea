...
pub(crate) struct DocumentStableTailLayoutKey {
    ...
    pub(crate) fullscreen_modal_active: bool,
    pub(crate) command_panel_active: bool,
...
impl Model {
    ...
    fn current_document_stable_tail_layout_key(&self) -> DocumentStableTailLayoutKey {
        ...
        DocumentStableTailLayoutKey {
            ...
            fullscreen_modal_active: self.top_modal_layer().is_some(),
            command_panel_active: self.command_panel_active(),
