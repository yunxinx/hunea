use crate::Model;
use ::mo_native_agent::models as native_models;
use ::mo_native_agent::models::ProviderSyncRequest;
use ::mo_native_agent::{ModelProviderRefreshEvent, ModelProviderRefreshRuntimeState};
...
pub(super) fn persist_selected_model(
    ...
    selection: &mo_core::model_catalog::ModelSelection,
) {
