...
pub(in crate::transcript) fn split_short_indent(line: &str) -> (String, &str) {
    let prefix_len = line
        .chars()
...
pub(in crate::transcript) fn looks_like_assistant_literal_line(line: &str) -> bool {
...
pub(in crate::transcript) fn render_cluster_for_display(
    cluster: &str,
...
pub(in crate::transcript) fn detect_fence_marker(line: &str) -> Option<&'static str> {
    let trimmed = line.trim();
